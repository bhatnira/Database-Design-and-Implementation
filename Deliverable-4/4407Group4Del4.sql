...
-- Generation Time: Mar 13, 2021 at 03:16 AM
...
--
ALTER TABLE `productOrder`
  MODIFY `orderNum` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
--
ALTER TABLE `transaction`
  MODIFY `salesAgreementNum` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10000011;
